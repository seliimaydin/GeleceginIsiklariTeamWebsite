          ...
          <div class="card">
              ...
              <div class="card-body">
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="form-group">
                              ...
                              <input name="aciklama" type="text" id="helperText" class="form-control" value="<?php echo $sponsorcek['aciklama'] ?>" placeholder="Enter new Description">

                              </p>
                          </div>
                          <div class="form-group">
                              <label for="helperText">Tier</label>
                              <input name="sira" type="text" id="helperText" class="form-control" value="<?php echo $sponsorcek['sira'] ?>" placeholder="Enter new tier">
                      ...
                      <div class="buttons">
           <button name="sponsorduzenle" type="submit" class="btn btn-outline-primary">Change</button>
        </div>
                      </div>
                  </div>
              </div>
