...
<?php require_once 'sidebar.php'; ?>
  ...
  <th style="float:right"><a href="addgallery.php"><button style="width: 150px" class="btn btn-outline-primary">Add Client</button></th>
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="float:right">
                            ...
                            <button name="sponsorsil" class="btn btn-outline-danger">Delete</button>
                                                          </form>
                                                          <td style="float:right"><a href="editgallery.php?id=<?php echo $sponsorcek['id'] ?>"><button class="btn btn-outline-success">Edit</button></a></td>
